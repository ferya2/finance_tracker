...
function PreviewCard() {
  ...
  return (
    <div
      aria-hidden
      className="relative hidden w-full max-w-sm overflow-hidden rounded-2xl border border-border bg-surface/80 p-5 shadow-xl shadow-black/10 backdrop-blur lg:block"
    >
